...
void command_interpreter(struct char_data *ch, char *argument)
{
    ...
    if ( (cmd > 0) && (cmd_info[cmd].command_pointer != 0))
    {
        ...
        else
        {
            ...
            //
            // The corresponding function from the command being executed
            // is referenced here, and the necessary parameters are passed
            // along.
            //
            //     'look' points to do_look:
            //                   do_look(ch, argument+begin+look_at, cmd)
            //
        ...
        case CON_SLCT:
            ...
            switch (*arg)
            {
                ...
                case '1':
                    ...
                    {
                        mudlog("Loading chars equipment and transferring to room.");
